...
Skill Nest is a full-stack course selling website where users can browse courses, open course details, log in with email, enroll in courses, and track enrolled items from a dashboard. Admin users can create, update, and delete courses from a separate admin page.
